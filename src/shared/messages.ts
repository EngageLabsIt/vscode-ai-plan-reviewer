import type { Plan, Version, Section, Comment, DiffLine, MappedComment } from './models';
...
export type HostMessage =
  ...
  | { type: 'planStatusUpdated'; payload: { planId: string; status: Plan['status'] } }
  | { type: 'diffLoaded'; payload: { diffLines: DiffLine[]; oldVersionNumber: number; newVersionNumber: number; mappedComments: MappedComment[] } }
