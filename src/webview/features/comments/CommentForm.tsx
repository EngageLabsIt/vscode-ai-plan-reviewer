...
export const CommentForm: React.FC = () => {
  const { onCommentSubmit: onSubmit, closeCommentForm: onCancel } =
    useComments();
    ...
    <div className='comment-form-inline'>
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className='comment-form-inline__actions'>
          <button
            type='button'
            className='comment-form-inline__btn comment-form-inline__btn--cancel'
            onClick={onCancel}
          >
            Cancel
          </button>
          <button
            type='submit'
            className='comment-form-inline__btn comment-form-inline__btn--submit'
